...
from .db_models import CustomerRecord, LoanRecord, RepaymentRecord, DocumentRecord, CustomerJourneyRecord
...
def profile_payload(customer_id: int, db: Session) -> dict:
    ...
    risk = {"total_score": None,"source":"scorecard_not_configured","risk_tier":"Not assessed","decision":"Not assessed","age":None,"bank_verification":None,"credit_score":c.cibil_score,"credit_enquiries":None,"negative_balance":None,"monthly_income":c.monthly_income,"bank_vintage":None,"dpd_analysis":None,"debt_analysis":None,"cheque_return":None}
