...
from .post_100_operations import router as post_100_operations_router
from .collection_routes import router as collection_router
from .bank_analysis_routes import router as bank_analysis_router
...
from .phase2d_routes import router as phase2d_router
from .phase2e_routes import router as phase2e_router
from .phase2f_routes import router as phase2f_router
from .phase2g_routes import router as phase2g_router
from .phase2h_routes import router as phase2h_router
from .phase2i_routes import router as phase2i_router
from .phase2j_routes import router as phase2j_router
...
from .phase2o_routes import router as phase2o_router
from .phase2p_routes import router as phase2p_router
from .phase2q_routes import router as phase2q_router
...
from .phase3a_funding_routes import router as phase3a_router
from .phase3b_investor_reporting_routes import router as phase3b_router
from .phase3c_securitisation_routes import router as phase3c_router
from .phase3d_pricing_routes import router as phase3d_router
